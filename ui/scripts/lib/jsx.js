...
const JSX = {
  ...
  // where the `title` prop lands: a UI kit with its own tooltips points it at data-tooltip
  TitleAttr: "title",
  ...
  createElement: (tag, props, ...children) => {
    ...
    if(typeof tag === "function") {
      // spread props may carry children: <X {...rest} /> keeps them when the tag has none
      const kids = children.length || !props?.children ? children : props.children;
      return tag({ ...props, children: kids });
    }
    ...
    Object.entries(props || {}).forEach(([name, value]) => {
      ...
      if(name === "title") name = JSX.TitleAttr;
