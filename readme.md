...
├─ deploy.js           (puts built `index.html` on a Cloudflare Worker)
├─ utils.js            (shared helpers for `build.js`, `serve.js` + `deploy.js`)
...
Framework consists of two scripts: a development **server** and a **build** tool.
